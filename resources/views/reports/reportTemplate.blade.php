...
<div class="card" style="width: 90%; ">
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            <form action="{{route('rutaPrueba',$treport)}}" class="form-group" style="width:50%" method="POST">
            @csrf
                @if($treport != 'epm')
                    <div class="row m-2">
                        <div class="col">
                            <label for="select_periodo">Proximos:</label>
...
<script>
    ...
    function obtenerPrimerDiaSemana(fecha){
        ...
        diasFaltantes = diaSemana + (7-diaSemana); 

        siguienteFecha = sumaDia(fecha, diasFaltantes);
