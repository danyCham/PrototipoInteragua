...
<div class="card" style="width: 80%; ">
    ...
    <div class="card-body">
        <div class="d-flex justify-content-end">
            <a class="btn pdf" data-toggle="tooltip" data-placement="bottom" title="Generar Reporte en PDF" href="{{ route('pdfGenerate') }}">
            ...
            <a class="btn csv" data-toggle="tooltip" data-placement="bottom" title="Generar archivo CSV"  href="{{ route('pdfGenerate') }}">
