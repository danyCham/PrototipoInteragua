    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a class="btn pdf" data-toggle="tooltip" data-placement="bottom" title="Generar Reporte en PDF" href="{{ route('pdfGenerate',1) }}">
                ...
                <a class="btn csv" data-toggle="tooltip" data-placement="bottom" title="Generar archivo CSV"  href="{{ route('csvGenerate') }}">
